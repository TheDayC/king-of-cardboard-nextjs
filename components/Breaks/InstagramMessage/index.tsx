        ...
        <div className="flex flex-col justify-center items-center">
            <div className="card lg:card-side bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <p className="mb-4">
                        As we develop our reputation and continue to offer the best breaking experience in the UK, we
                        have temporarily migrated our break offerings to our Instagram page.
                    </p>
                    <p className="mb-4">
                        Our goals are still the same but our focus has shifted slightly. You can still find sealed,
                        singles and everything in between in our shop, that won't go away, but for now breaks will
                        happen in the Instagram ecosystem.
                    </p>
                    <p className="mb-4">
                        If you wish to get involved with our breaks please click the button below and head over to our
                        Instagram page that will allow you to claim slots by commenting, or even negotiate deals with
                        us!
                    </p>
