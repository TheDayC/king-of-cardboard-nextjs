        ...
        <div className="card shadow-md rounded-md bordered pt-4 transition duration-300 ease-in-out hover:shadow-2xl">
                ...
                <div className="relative h-40 flex flex-row justify-center">
                    {cardImage.url.length > 0 && (
                        <Link
                            ...
                            passHref
                        >
                            <div className="block rounded-md overflow-hidden shadow-md cursor-pointer w-auto">
                                <img
            ...
            <div className="justify-between items-start card-body p-0">
                <div className="flex flex-col justify-start items-start w-full">
                    ...
                    {tags && (
                        <div
                            className={`flex flex-row flex-wrap justify-center items-start w-full px-2 lg:px-6${
                                isLive || isComplete ? ' mb-6' : ''
                            }`}
                        >
                            {tags.map((tag) => (
                                <div
