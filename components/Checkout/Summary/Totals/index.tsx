...
export const Totals: React.FC<CartTotalsProps> = ({ isConfirmation }) => {
    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-row w-full justify-end align-center space-x-2 border-b border-gray-300 p-4">
            ...
            <div className="flex flex-row w-full justify-end align-center space-x-2 p-4">
