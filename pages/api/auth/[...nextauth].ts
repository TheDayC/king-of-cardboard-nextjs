...
export default async function auth(req: NextApiRequest, res: NextApiResponse): Promise<void> {
    return await NextAuth(req, res, {
        ...
        pages: {
            signIn: `${process.env.NEXT_PUBLIC_SITE_URL || process.env.VERCEL_URL}/account`,
            signOut: `${process.env.NEXT_PUBLIC_SITE_URL || process.env.VERCEL_URL}/login?signedOut=true`,
            error: `${process.env.NEXT_PUBLIC_SITE_URL || process.env.VERCEL_URL}/login`, // Error code passed in query string as ?error=
            newUser: `${process.env.NEXT_PUBLIC_SITE_URL || process.env.VERCEL_URL}/account`,
        },
        callbacks: {
